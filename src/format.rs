...
pub fn flags_to_subtype_format(flags: c_int) -> Option<SubtypeFormat> {
  match flags & sndfile_sys::SF_FORMAT_SUBMASK {
    ...
    sndfile_sys::SF_FORMAT_MPEG_LAYER_I => Some(SubtypeFormat::MPEG_1),
    sndfile_sys::SF_FORMAT_MPEG_LAYER_II => Some(SubtypeFormat::MPEG_2),
    sndfile_sys::SF_FORMAT_MPEG_LAYER_III => Some(SubtypeFormat::MPEG_3),
    _ => None,
  }
}
...
pub fn subtype_format_to_flags(subtype_format: SubtypeFormat) -> c_int {
  match subtype_format {
    ...
    SubtypeFormat::MPEG_1 => sndfile_sys::SF_FORMAT_MPEG_LAYER_I,
    SubtypeFormat::MPEG_2 => sndfile_sys::SF_FORMAT_MPEG_LAYER_II,
    SubtypeFormat::MPEG_3 => sndfile_sys::SF_FORMAT_MPEG_LAYER_III,
  }
}
...
pub fn default_subtype(major_format: MajorFormat) -> Option<SubtypeFormat> {
  match major_format {
    ...
    MajorFormat::MPEG => Some(SubtypeFormat::MPEG_3),
  }
}
